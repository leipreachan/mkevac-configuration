...
" gdefault is ruining substitute
let s:old_gdefault = &gdefault
set nogdefault
...
if exists("html_use_css")
  if exists("html_no_pre")
    ...
    execute '%s!<div>!<div style="background-color:' . s:bgc . ';color:' . s:fgc . ';font-family:'. s:htmlfont .'; padding:1em">'
endif
